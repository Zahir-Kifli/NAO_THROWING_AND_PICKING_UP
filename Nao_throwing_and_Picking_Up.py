...
# Add this new function after calculate_throw_parameters
...
def main(robot_ip, port):
    ...
    try:
        ...
        # Open hand for ball placement ( REMOVE THIS WHEN COMBINED: OPEN HAND)
        motion_proxy.setStiffnesses("LWristYaw", 1.0)    
        motion_proxy.setAngles("LWristYaw", 2.0, 0.2)
        #time.sleep(1) 
        #motion_proxy.openHand("LHand")
        #tts_proxy.say("Please place the ball in my hand")
        #time.sleep(0.5)

        # Partially close hand
        motion_proxy.setStiffnesses("LHand", 1.0)
        ...
        target_angles = {
            "HeadPitch": 0.3,       # Head slightly up (NEW)  
        ...
        # Optionally, you can add a delay here to maintain the pose
        time.sleep(2.0)
